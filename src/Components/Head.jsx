        ...
        <>
            <nav className='fixed z-[100] w-full'>
                ...
                <div className='flex font-popp bg-[#fdcc03] p-[0.35rem] gap-3 z-10 w-full h-[2.5rem] text-slate-950 rounded-b-lg transition-all'>
                    ...
                    <div className={`flex group items-center justify-end grow gap-3 ${hdr}`}>
                        {socls.map((socl, i) => (
                            <a href={socl.Link}><img src={socl.Ico} alt={socl.Name} className={`w-fit h-[1rem] group-[.showoff]:animate-[Social_2s_ease-in-out_forwards] 
                                text-transparent
